...
var _mapObj = require('../utils/mapObj');
...
var _ValueWithMeta = require('../ValueWithMeta');

var _ValueWithMeta2 = _interopRequireDefault(_ValueWithMeta);
...
var inheritMappings = function inheritMappings(mappings, parentMappings) {
  return (0, _mapObj2.default)(mappings, function (singleMapping, mappingName) {
    singleMapping = typeof singleMapping === 'string' ? { url: singleMapping } : singleMapping;

    var mergedMapping = Object.assign({}, parentMappings[mappingName], singleMapping);

    return 'value' in mergedMapping && 'url' in mergedMapping ? (0, _omit2.default)(mergedMapping, 'url' in singleMapping ? 'value' : 'url') : mergedMapping;
  });
};
  ...
  return function wrapWithConnect(WrappedComponent) {
    var RefetchConnect = function (_Component) {
      ...
      RefetchConnect.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps, nextContext) {
        if (!options.pure || dependsOnProps && !(0, _shallowEqual2.default)((0, _omit2.default)(this.props, 'children'), (0, _omit2.default)(nextProps, 'children')) || dependsOnContext && !(0, _shallowEqual2.default)(this.context, nextContext)) {
      ...
      RefetchConnect.prototype.render = function render() {
        ...
        return _react2.default.createElement(WrappedComponent, _extends({}, this.props, this.state.data, { ref: ref }));
      };
      ...
      RefetchConnect.prototype.refetchDataFromProps = function refetchDataFromProps() {
        ...
        this.refetchDataFromMappings(finalMapPropsToRequestsToProps((0, _omit2.default)(props, 'children'), context) || {});
      };
        ...
        Object.keys(mappings).forEach(function (prop) {
          ...
          if (Function.prototype.isPrototypeOf(mapping)) {
            _this3.setAtomicState(prop, new Date(), mapping, function () {
              _this3.refetchDataFromMappings(inheritMappings(mapping.apply(undefined, arguments), _this3.state.mappings));
            });
            return;
          }
        ...
        if (mapping.hasOwnProperty('value')) {
          ...
          if (value && typeof value.then === 'function') {
            ...
            return value.then(function (val) {
              return val instanceof _ValueWithMeta2.default ? onFulfillment(val.meta)(val.value) : onFulfillment(meta)(val);
            }, function (val) {
              return val instanceof _ValueWithMeta2.default ? onRejection(val.meta)(val.value) : onRejection(meta)(val);
            });
          } else {
        ...
        return function (meta) {
          return function (value) {
            ...
            _this6.setAtomicState(prop, startedAt, mapping, _PromiseState2.default.resolve(value, meta), refreshTimeout, function () {
              if (mapping.andThen) {
                _this6.refetchDataFromMappings(inheritMappings(mapping.andThen(value, meta), _this6.state.mappings));
              }
            });
          };
        };
        ...
        return function (meta) {
          return function (reason) {
            ...
            _this7.setAtomicState(prop, startedAt, mapping, _PromiseState2.default.reject(reason, meta), null, function () {
              if (mapping.andCatch) {
                _this7.refetchDataFromMappings(inheritMappings(mapping.andCatch(reason, meta), _this7.state.mappings));
              }
            });
          };
        };
