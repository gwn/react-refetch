        ...
        if (mapping.hasOwnProperty('value')) {
          ...
          if (value && typeof value.then === 'function') {
            ...
            return value.then(function (val) {
              return val instanceof _PromiseState2.default ? onFulfillment(val.meta)(val.value) : onFulfillment(meta)(val);
            }, function (reason) {
              return reason instanceof _PromiseState2.default ? onRejection(reason.meta)(reason.reason) : onRejection(meta)(reason);
            });
          } else {
